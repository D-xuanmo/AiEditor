...
export class Popover {
  ...
  setTrigger(
    ...
    triggerType: 'mouseenter focus' | 'click' | 'focusin' | 'mouseenter click' | 'manual' = 'click'
  ) {
  ...
  createContentElement() {
    ...
    container.querySelector('.aie-popover-header-close')!.addEventListener('click', () => {
      this.tippyInstance!.hide()
    })

    container.querySelector('.aie-popover-footer-confirm')!.addEventListener('click', () => {
